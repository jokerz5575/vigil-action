...
def main() -> int:
    ...
    try:
        ...
        print(
            "::error::ossentinel-cli is not installed. Please check your workflow configuration."
        )
        return 1
...
def _write_job_summary(report) -> None:
    ...
    lines.append("\n---")
    lines.append(
        "*Generated by [OSSentinel](https://github.com/jokerz5575/vigil) — Open source compliance, automated.*"
    )
